...
(function () {
    ...
    navStyle.textContent = [
        ...
        '#navi .active,#navi a.active{background:var(--nv-active,rgba(127,127,200,0.45))!important;color:var(--nv-text,#fff)!important;font-weight:bold!important;border-left:3px solid var(--nv-border,#aaf)!important;padding-left:7px!important;}',
        'a:hover{background:var(--nv-hover,rgba(127,127,200,0.20))!important;color:var(--nv-text,#fff)!important;}',
