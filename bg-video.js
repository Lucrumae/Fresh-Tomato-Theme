...
(function () {
    ...
    (function(){
        ...
        s.textContent = [
            ...
            '#navi a:hover { background: var(--nv-hover, rgba(120,120,200,0.25)) !important; border: 0 !important; color: var(--nv-text, #fff) !important; border-left: 3px solid var(--nv-border, #aaf) !important; padding-left: 7px !important; }',
            '#navi a.indent2.active { background: var(--nv-active, rgba(120,120,200,0.45)) !important; color: var(--nv-text-active, #fff) !important; font-weight: bold !important; border-left: 3px solid var(--nv-border, #aaf) !important; padding-left: 7px !important; }',
            '#navi a.indent1.active { background: transparent !important; color: var(--nv-border, #aaf) !important; font-weight: bold !important; border-left: 3px solid var(--nv-hover, rgba(120,120,200,0.5)) !important; padding-left: 7px !important; }',
            'ul.tabs a, #tabs a { background: rgba(10,10,20,0.35) !important; color: rgba(255,255,255,0.6) !important; border: 1px solid var(--nv-hover, rgba(120,120,200,0.25)) !important; }',
            'ul.tabs a.active, #tabs a.active { background: var(--nv-active, rgba(120,120,200,0.40)) !important; color: var(--nv-text, #fff) !important; font-weight: bold !important; border: 1px solid var(--nv-border, #aaf) !important; }',
            'ul.tabs a:hover, #tabs a:hover { background: var(--nv-hover, rgba(120,120,200,0.25)) !important; color: var(--nv-text, #fff) !important; }',
        ].join('\n');
        ...
        function updateNavAccent(){
            try{
                ...
                de.setProperty('--nv-hover','rgba('+hov+',0.28)');
                de.setProperty('--nv-active','rgba('+act+',0.50)');
                de.setProperty('--nv-border','rgb('+brd+')');
                de.setProperty('--nv-text',txtHover);
                de.setProperty('--nv-text-active',txtActive);
                ...
                if(_sd){
                    ...
                    _ss.textContent=[
                        '#svg text { fill: '+_tc+' !important; paint-order: stroke fill; stroke: '+_oc+'; stroke-width: 2.5px; stroke-linejoin: round; }',
                        '.svg-tickH { fill: '+_tc+' !important; text-anchor: middle; paint-order: stroke fill; stroke: '+_oc+'; stroke-width: 2.5px; stroke-linejoin: round; }',
