...
(function () {
    ...
    (function(){
        ...
        s.textContent = [
            ...
            '#navi a.indent2.active { background: var(--nv-active, rgba(120,120,200,0.45)) !important; color: var(--nv-text, #fff) !important; font-weight: bold !important; border-left: 3px solid var(--nv-border, #aaf) !important; padding-left: 7px !important; }',
        ...
        function updateNavAccent(){
            try{
                ...
                var txt=(rl+0.05)/(0.0+0.05)>3.5?'#111':'#fff';
