...
http {
    # Sembunyikan versi nginx dari response header dan error pages
    server_tokens off;
    ...
    # Rate limiting — 20 req/s umum, 5 req/menit untuk login
    limit_req_zone \$binary_remote_addr zone=general:1m rate=20r/s;
    ...
    server {
        ...
        # Custom error pages — jangan expose nginx version
