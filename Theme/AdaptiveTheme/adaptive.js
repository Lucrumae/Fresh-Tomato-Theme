...
(function () {
    ...
    navStyle.textContent = [
        ...
        '#navi .active,#navi a.active{background:var(--accent-secondary,rgba(127,127,200,0.45))!important;color:var(--text-primary,#fff)!important;font-weight:bold!important;border-left:3px solid var(--accent-highlight,#aaf)!important;padding-left:7px!important;}',
        'a:hover{background:var(--accent-primary,rgba(127,127,200,0.20))!important;color:var(--text-primary,#fff)!important;}',
        'ul.tabs a:hover,#tabs a:hover{background:var(--accent-primary,rgba(127,127,200,0.20))!important;color:var(--text-primary,#fff)!important;}',
        ...
        'input[type="button"]:hover,input[type="submit"]:hover{background:var(--accent-primary,rgba(127,127,200,0.20))!important;color:var(--text-primary,#fff)!important;}',
    ].join('');
