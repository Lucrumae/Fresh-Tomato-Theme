...
(function () {
    ...
    // yang diupdate real-time oleh applyPalette() saat video disampling.
    ...
    navStyle.textContent = [
        ...
        '#navi a:hover{background:var(--accent-primary,rgba(127,127,200,0.22))!important;border:0!important;color:var(--text-primary,#fff)!important;border-left:3px solid var(--accent-highlight,#aaf)!important;padding-left:7px!important;}',
        '#navi a.indent2.active{background:var(--accent-secondary,rgba(127,127,200,0.45))!important;color:var(--text-primary,#fff)!important;font-weight:bold!important;border-left:3px solid var(--accent-highlight,#aaf)!important;padding-left:7px!important;}',
        '#navi a.indent1.active{background:transparent!important;color:var(--accent-highlight,#aaf)!important;font-weight:bold!important;border-left:3px solid var(--accent-highlight,#aaf)!important;padding-left:7px!important;}',
        'ul.tabs a:hover,#tabs a:hover{background:var(--accent-primary,rgba(127,127,200,0.22))!important;color:var(--text-primary,#fff)!important;}',
        'ul.tabs a.active,#tabs a.active{background:var(--accent-secondary,rgba(127,127,200,0.45))!important;color:var(--text-primary,#fff)!important;}',
        'input[type="button"]:hover,input[type="submit"]:hover{background:var(--accent-primary,rgba(127,127,200,0.22))!important;color:var(--text-primary,#fff)!important;}',
    ].join('');
    document.head.appendChild(navStyle);

    // -- ADAPTIVE THEME STYLE ----------------------------------------
    // Override semua hardcoded colors di tomato.css:
    // container (#fff), tabs (#f3f3f3/#af4141), SVG chart (#fcfcfc),
    // .bwmg table, .tomato-grid, #header — semua pakai CSS vars dari
    // applyPalette() → auto-update tiap video frame sample
    ...
    themeStyle.textContent = [
        ...
        '#header{background:var(--header-bg,rgba(10,8,20,0.60))!important;border-bottom:1px solid var(--accent-primary,rgba(127,127,200,0.25))!important;}',
        '#header .title,#header .version{color:var(--text-primary,#fff)!important;}',
        '.section-title{color:var(--text-primary,#eee)!important;border-bottom:1px solid var(--accent-primary,rgba(127,127,200,0.25))!important;}',
        'ul.tabs a,#tabs a,.tabs a{background:var(--tab-bg,rgba(20,15,30,0.35))!important;color:var(--text-secondary,#aaa)!important;border:1px solid var(--accent-primary,rgba(127,127,200,0.15))!important;}',
        'ul.tabs a.active,#tabs a.active,.tabs a.active{background:var(--tab-active-bg,rgba(127,127,200,0.22))!important;color:var(--text-primary,#fff)!important;font-weight:bold!important;border:1px solid var(--accent-highlight,#aaf)!important;}',
        'ul.tabs a:hover,#tabs a:hover,.tabs a:hover{background:var(--accent-primary,rgba(127,127,200,0.22))!important;color:var(--text-primary,#fff)!important;}',
        '.svg-rect{fill:var(--svg-bg,rgba(10,8,20,0.30))!important;}',
        '#svg text,.svg-text,svg text{fill:var(--svg-text-color,#ddd)!important;}',
        '.svg-tickH,.svg-tickV{fill:var(--svg-text-color,#ccc)!important;}',
        '.svg-textback,.svg-textback-vertical{fill:var(--header-bg,rgba(10,8,20,0.55))!important;opacity:0.75!important;}',
        '.svg-line{stroke:var(--svg-grid-stroke,rgba(127,127,200,0.15))!important;}',
        '.svg-line.a{stroke:var(--svg-grid-stroke,rgba(127,127,200,0.10))!important;}',
        '.svg-path{stroke-opacity:0.7!important;}',
        '.bwmg{background:var(--panel-bg,rgba(10,8,20,0.28))!important;border:1px solid var(--bwm-border,rgba(127,127,200,0.18))!important;}',
        '.bwmg .header,.bwmg thead{background:var(--header-bg,rgba(10,8,20,0.50))!important;color:var(--text-primary,#eee)!important;}',
        '.bwmg .footer{background:var(--panel-bg,rgba(10,8,20,0.35))!important;color:var(--text-secondary,#aaa)!important;}',
        '.bwmg .odd{background:var(--row-odd,rgba(127,127,200,0.02))!important;color:var(--text-value,#ddd)!important;}',
        '.bwmg .even{background:var(--row-even,rgba(127,127,200,0.06))!important;color:var(--text-value,#ddd)!important;}',
        '.bwmg td{color:var(--text-value,#ddd)!important;}',
        '.tomato-grid{background:var(--panel-bg,rgba(10,8,20,0.28))!important;border:1px solid var(--accent-primary,rgba(127,127,200,0.15))!important;}',
        '.tomato-grid .header{background:var(--header-bg,rgba(10,8,20,0.50))!important;color:var(--text-primary,#eee)!important;}',
        '.tomato-grid .footer{background:var(--panel-bg,rgba(10,8,20,0.35))!important;}',
        '.tomato-grid .odd{background:var(--row-odd,rgba(127,127,200,0.02))!important;}',
        '.tomato-grid .even{background:var(--row-even,rgba(127,127,200,0.06))!important;}',
        '.tomato-grid .odd:hover,.tomato-grid .even:hover{background:var(--accent-primary,rgba(127,127,200,0.18))!important;}',
        '.tomato-grid td,.tomato-grid th{color:var(--text-value,#ddd)!important;}',
        '#bwm-stats,#bwm-stats td{color:var(--text-value,#ddd)!important;background:transparent!important;}',
        '#bwm-last{background:transparent!important;color:var(--text-secondary,#aaa)!important;}',
        '#bwm-controls{color:var(--text-secondary,#aaa)!important;}',
        'td,th{color:var(--text-value,#ddd)!important;}',
        'input[type="text"],input[type="password"],select,textarea{background:var(--input-bg,rgba(10,8,20,0.85))!important;color:var(--input-color,#eee)!important;border:1px solid var(--input-border,rgba(127,127,200,0.25))!important;}',
        'input[type="button"],input[type="submit"]{background:var(--btn-bg,rgba(127,127,200,0.22))!important;color:var(--btn-color,#fff)!important;border:1px solid var(--accent-primary,rgba(127,127,200,0.30))!important;}',
        '*::-webkit-scrollbar{width:6px;height:6px;}',
        '*::-webkit-scrollbar-track{background:var(--scrollbar-track,rgba(127,127,200,0.05))!important;}',
        '*::-webkit-scrollbar-thumb{background:var(--scrollbar-thumb,rgba(127,127,200,0.40))!important;border-radius:3px;}',
        '*::-webkit-scrollbar-thumb:hover{background:var(--scrollbar-hover,rgba(127,127,200,0.65))!important;}'
    ].join('');
