...
(function () {
    ...
    function injectSVGTheme(txtCol, outlineCol, rectFill, lineFill, backFill){
        ...
        s.textContent = [
            '#svg text { fill: '+txtCol+' !important; paint-order: stroke fill; stroke: '+outlineCol+'; stroke-width: 2.5px; stroke-linejoin: round; }',
            '.svg-tickH { fill: '+txtCol+' !important; text-anchor: middle; paint-order: stroke fill; stroke: '+outlineCol+'; stroke-width: 2.5px; stroke-linejoin: round; }',
    ...
    (function(){
        ...
        s.id = 'ft-nav-hover';
        s.textContent = [
            // Transisi smooth untuk semua link di nav
            '#navi a { transition: background 0.18s, color 0.18s, border-left 0.18s, padding-left 0.15s !important; color: var(--nav-text-idle, var(--text-secondary)) !important; }',
            // Hover: semi-transparan accent — video masih terlihat di balik
            '#navi a:hover { background: var(--accent-primary) !important; border: 0 !important; color: var(--nav-text-hover, #fff) !important; border-left: 3px solid var(--accent-highlight) !important; padding-left: 7px !important; }',
            // indent2.active = halaman aktif: warna solid tapi kontras
            '#navi a.indent2.active { background: var(--accent-secondary) !important; color: var(--nav-text-active, #fff) !important; font-weight: bold !important; border-left: 3px solid var(--accent-highlight) !important; padding-left: 7px !important; }',
            // indent1.active = parent section terbuka: TIDAK ada bg, hanya strip kiri + warna teks
            '#navi a.indent1.active { background: transparent !important; color: var(--accent-highlight) !important; font-weight: bold !important; border-left: 3px solid var(--accent-primary) !important; padding-left: 7px !important; }',
            // Tabs default: hapus #f3f3f3 abu terang
            'ul.tabs a, #tabs a { background: var(--tab-bg) !important; color: var(--text-secondary) !important; border: 1px solid var(--accent-primary) !important; }',
            // Tab active: --tab-active-bg (rgba accent 20%) bukan #af4141 solid
            'ul.tabs a.active, #tabs a.active { background: var(--tab-active-bg) !important; color: var(--text-primary) !important; font-weight: bold !important; border: 1px solid var(--accent-highlight) !important; }',
            // Tab hover
            'ul.tabs a:hover, #tabs a:hover { background: var(--accent-primary) !important; color: var(--text-primary) !important; }',
        ].join('\n');
