...
(function () {
    ...
    window.confirm = function(msg){
        ...
        // Jika pesan ini sudah dikonfirmasi user (dalam 2 detik), bypass
        var key = msg||'';
        if(_ftConfirmedMsgs[key] && Date.now() < _ftConfirmedMsgs[key]){
            delete _ftConfirmedMsgs[key];
            return true;
        }
        var caller = null;
        ...
        document.getElementById('ft-dlg-yes').addEventListener('click',function(){
            ...
            setTimeout(function(){
                if(type==='halt'){
                    ...
                    _ftConfirmedMsgs[msg] = Date.now() + 3000;
