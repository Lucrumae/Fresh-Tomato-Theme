...
(function () {
    ...
    vidStyle.textContent = '#bg-video{position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:-1;object-fit:cover;object-position:center center;pointer-events:none;}#navi a.indent1.active{margin:2px 5px 2px 5px!important;padding-left:5px!important;border:1.5px solid currentColor!important;border-radius:6px!important;background:rgba(128,128,128,0.08)!important;text-shadow:1px 1px 3px rgba(0,0,0,0.55),0 0 8px currentColor!important;filter:brightness(1.2)!important;}#navi a.indent2.active{padding-left:5px!important;margin:2px 5px 2px 5px!important;border:1.5px solid currentColor!important;border-radius:6px!important;text-shadow:1px 1px 3px rgba(0,0,0,0.55),0 0 8px currentColor!important;filter:brightness(1.35)!important;}#navi a:hover{background:rgba(255,255,255,0.08)!important;backdrop-filter:blur(12px) saturate(1.4)!important;-webkit-backdrop-filter:blur(12px) saturate(1.4)!important;border:1px solid rgba(255,255,255,0.18)!important;border-radius:6px!important;margin:1px 5px!important;box-shadow:inset 0 1px 0 rgba(255,255,255,0.15),0 2px 8px rgba(0,0,0,0.25)!important;transition:background 0.2s,backdrop-filter 0.2s,border 0.2s!important;}';
