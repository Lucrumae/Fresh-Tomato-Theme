...
(function () {
    ...
    vidStyle.textContent = '#bg-video{position:fixed;top:0;left:0;width:100vw;height:100vh;z-index:-1;object-fit:cover;object-position:center center;pointer-events:none;}#navi a.indent1.active{margin:2px 5px 0 5px!important;padding-left:5px!important;border:1.5px solid currentColor!important;border-bottom:none!important;border-radius:6px 6px 0 0!important;background:rgba(128,128,128,0.08)!important;text-shadow:-1px -1px 0 rgba(255,255,255,0.25),1px 1px 3px rgba(0,0,0,0.55),0 0 8px currentColor!important;filter:brightness(1.2)!important;}#navi a.indent2.active{padding-left:5px!important;margin:0 5px 2px 5px!important;border:1.5px solid currentColor!important;border-top:none!important;border-radius:0 0 6px 6px!important;text-shadow:-1px -1px 0 rgba(255,255,255,0.25),1px 1px 3px rgba(0,0,0,0.55),0 0 8px currentColor!important;filter:brightness(1.35)!important;}';
