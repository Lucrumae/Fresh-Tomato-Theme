...
(function () {
    ...
    function _injectNavStyle(){
        ...
        navStyle.textContent='td#navi a,#navi a{display:block;margin:2px 5px;padding-left:5px;border:1.5px solid transparent;border-radius:6px;transition:background 0.14s cubic-bezier(0.25,0.46,0.45,0.94),border-color 0.14s cubic-bezier(0.25,0.46,0.45,0.94),filter 0.14s cubic-bezier(0.25,0.46,0.45,0.94);}td#navi a:hover,#navi a:hover{background:rgba(255,255,255,0.09)!important;backdrop-filter:blur(14px) saturate(1.5)!important;-webkit-backdrop-filter:blur(14px) saturate(1.5)!important;border-color:rgba(255,255,255,0.20)!important;filter:brightness(1.14)!important;}td#navi a:active,#navi a:active{filter:brightness(0.96)!important;transition-duration:0.08s!important;}td#navi a.indent1.active,#navi a.indent1.active,#navi:not(:hover) a.indent1.active,td#navi:not(:hover) a.indent1.active{border-color:currentColor!important;background:rgba(255,255,255,0.05)!important;backdrop-filter:blur(10px) saturate(1.3)!important;-webkit-backdrop-filter:blur(10px) saturate(1.3)!important;filter:brightness(1.55)!important;color:inherit!important;}td#navi a.indent2.active,#navi a.indent2.active{border-color:rgba(255,255,255,0.28)!important;background:rgba(255,255,255,0.05)!important;backdrop-filter:blur(10px) saturate(1.3)!important;-webkit-backdrop-filter:blur(10px) saturate(1.3)!important;filter:brightness(1.55)!important;color:inherit!important;}td#navi a.indent2.active::after,#navi a.indent2.active::after,td#navi:not(:hover) a.indent1.active::after,#navi:not(:hover) a.indent1.active::after{display:none!important;}td#navi a.indent1:has(+div a.indent2.active),#navi a.indent1:has(+div a.indent2.active),td#navi a.indent1.ft-sub-active,#navi a.indent1.ft-sub-active{border-color:rgba(255,255,255,0.28)!important;background:rgba(255,255,255,0.05)!important;backdrop-filter:blur(10px) saturate(1.3)!important;-webkit-backdrop-filter:blur(10px) saturate(1.3)!important;filter:brightness(1.55)!important;}';
