...
(function () {
    ...
    window.confirm = function(msg){
        ...
        // Cek apakah caller sudah punya confirmed token — bypass sekali
        var caller = null;
        try { caller = document.activeElement; } catch(e){}
        if(caller && caller.getAttribute('data-ft-ok') === msg){
            caller.removeAttribute('data-ft-ok');
            return true;
        }
        ...
        document.getElementById('ft-dlg-yes').addEventListener('click',function(){
            ...
            setTimeout(function(){
                if(type==='halt'){
                    ...
                    // Set token pada caller agar confirm-nya di-bypass sekali
                    if(caller.setAttribute) caller.setAttribute('data-ft-ok', msg);
