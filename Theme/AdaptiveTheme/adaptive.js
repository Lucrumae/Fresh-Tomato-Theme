...
(function () {
    ...
    (function(){
        ...
        s.textContent = [
            ...
            '#navi a:hover { background: var(--accent-primary) !important; border: 0 !important; color: var(--text-primary) !important; border-left: 3px solid var(--accent-highlight) !important; padding-left: 7px !important; }',
            // indent2.active = halaman aktif: warna solid tapi kontras
            '#navi a.indent2.active { background: var(--accent-secondary) !important; color: var(--text-primary) !important; font-weight: bold !important; border-left: 3px solid var(--accent-highlight) !important; padding-left: 7px !important; }',
